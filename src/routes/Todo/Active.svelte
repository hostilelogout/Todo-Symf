<script>
  ...
  import {CreateToggle} from './CreateTask.svelte';
...
<div class="b-example-divider b-example-vr"></div>
  <div class="d-flex flex-column align-items-stretch flex-shrink-0 bg-body-tertiary" style="width: 380px;">
    <a href="/" class="d-flex align-items-center flex-shrink-0 p-3 link-body-emphasis text-decoration-none border-bottom">
      ...
      <span class="fs-5 fw-semibold">Active Tasks</span>
      <button on:click={CreateToggle} type="button" class="btn btn-outline-primary" style="margin-left: 50px;">Add Task</button>
    </a>
    <div class="list-group list-group-flush border-bottom scrollarea">
      {#each activeTasks as {taskid,title,description,day},i}
        {#if activeTasks.at(i)?.active && !activeTasks.at(i)?.ongoing}
